...
def keras2neat(neat_config, keras_h5_path, new_genome_key, run_name='1', generation=''):
    ...
    visualize.draw_net(neat_config, new_genome, view=False, filename="eval/run_{}/keras2neat/{}_gen_{}".format(run_name, new_genome_key,
                                                                                                               generation))
